        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 col-md-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-4">
                            <h4 class="header-title mb-0">Manufacturing Progress</h4>
                        </div>
                        <div class="table-responsive">
                            <table class="dbkit-table">
                                <tbody>
                                    ...
                                    <?php 
                                    $a=1;
                                    foreach ($manufacturing_progress as $val) { ?>
                                    <tr>
                        ...
                        <div class="s-member">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body ml-5">
                                    <p><?php echo $value->username ?></p><span><?php if($value->level==1){echo 'Administrator';}else{echo 'Pengguna';} ?></span>
                                </div>
                                <div class="tm-social">
...
<!-- <script src="<echo base_url('') ?>assets/js/bar-chart.js"></script> -->
    ...
    <script type="text/javascript">
        ...
        data: {
            labels: ["CONFIRMED", "IN PROGRESS", "DONE"],
            datasets: [{
                backgroundColor: [
                "#E36D68",
                "#F8CB3F",
